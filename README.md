...
This is the code repository for [Mastering Machine Learning with MATLAB [Video]](https://www.packtpub.com/big-data-and-business-intelligence/mastering-machine-learning-matlab-video?utm_source=github&utm_medium=repository&utm_campaign=9781788998130), published by [Packt](https://www.packtpub.com/?utm_source=github). It contains all the supporting project files necessary to work through the video course from start to finish.
...
This video course is for data analysts, data scientists, or anyone who wants to build efficient data processing and predicting applications. A mathematical and statistical background will really help. In addition, a basic knowledge of Machine Learning is expected.
